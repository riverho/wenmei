 ...
 * separate Wenmei window. Removal only detaches the folder from the vault
 * list (state.json); nothing on disk is touched. Full management lives in
 * Settings › Vaults.
 */
export default function VaultMenu({
  ...
  const spawnChildWindow = useAppStore(s => s.spawnChildWindow);
  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      {open && (
        <div
          className="absolute left-0 top-7 z-[150] w-72 rounded-xl overflow-hidden animate-scale-in"
          style={{
